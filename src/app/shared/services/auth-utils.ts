 ...
 * @param {*} config
 */
const initFirebaseBackend = (config: { apiKey: string; authDomain: string; projectId: string; storageBucket: string; messagingSenderId: string; appId: string; }) => {
    if (!_fireBaseBackend) {
...
const getFirebaseBackend = () => {
  ...
  return new FirebaseAuthBackend(obj);
